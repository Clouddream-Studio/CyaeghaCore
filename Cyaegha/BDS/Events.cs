...
namespace DNR
{
    ...
    public struct Std_Vector
    {
        ...
        public ArrayList toList()
        {
            ...
            ulong l = ((ulong)last - (ulong)data) / (ulong)IntPtr.Size;
            for (ulong i = 0; i < l; i++)
            {
    ...
    public class BaseEvent
    {
        ...
        /// 事件触发模式
        /// </summary>
        public ActMode MODE => mMODE;
        /// <summary>
        /// 事件结果（注册After事件时，此值有效）
        /// </summary>
        public bool RESULT => mRESULT;
    ...
    public class ServerCmdEvent : BaseEvent
    {
        ...
        /// 指令数据
        /// </summary>
        public string cmd => mcmd;
        public static new ServerCmdEvent getFrom(Events e)
        {
            ServerCmdEvent sce = createHead(e, EventType.onServerCmd, typeof(ServerCmdEvent)) as ServerCmdEvent;
            if (sce == null)
            {
                return sce;
            }
    ...
    public class ServerCmdOutputEvent : BaseEvent
    {
        ...
        /// 指令数据
        /// </summary>
        public string output => moutput;
        public static new ServerCmdOutputEvent getFrom(Events e)
        {
            ServerCmdOutputEvent soe = createHead(e, EventType.onServerCmdOutput, typeof(ServerCmdOutputEvent)) as ServerCmdOutputEvent;
            if (soe == null)
            {
                return soe;
            }
    ...
    public class PlayerEvent : BaseEvent
    {
        ...
        /// 玩家所在维度
        /// </summary>
        public string dimension => mdimension;
        /// <summary>
        /// 玩家所处位置
        /// </summary>
        public Vec3 XYZ => mXYZ;
        /// <summary>
        /// 玩家所在维度ID
        /// </summary>
        public int dimensionid => mdimensionid;
        /// <summary>
        /// 玩家是否立足于方块/悬空
        /// </summary>
        public bool isstand => misstand;
        /// <summary>
        /// 玩家指针
        /// </summary>
        public IntPtr playerPtr => mplayer;
    ...
    public class FormSelectEvent : PlayerEvent
    {
        ...
        /// 玩家uuid信息
        /// </summary>
        public string uuid => muuid;
        /// <summary>
        /// 表单回传的选择项信息
        /// </summary>
        public string selected => mselected;
        /// <summary>
        /// 表单ID
        /// </summary>
        public int formid => mformid;
        public static new FormSelectEvent getFrom(Events e)
        {
            FormSelectEvent fse = createHead(e, EventType.onFormSelect, typeof(FormSelectEvent)) as FormSelectEvent;
            if (fse == null)
            {
                return fse;
            }
    ...
    public class UseItemEvent : PlayerEvent
    {
        ...
        /// 操作方块所在位置
        /// </summary>
        public BPos3 position => mposition;
        /// <summary>
        /// 物品ID
        /// </summary>
        public short itemid => mitemid;
        /// <summary>
        /// 物品特殊值
        /// </summary>
        public short itemaux => mitemaux;
        /// <summary>
        /// 操作方块名称
        /// </summary>
        ...
        /// 操作方块id
        /// </summary>
        public short blockid => mblockid;
        public static new UseItemEvent getFrom(Events e)
        {
            UseItemEvent ue = createHead(e, EventType.onUseItem, typeof(UseItemEvent)) as UseItemEvent;
            if (ue == null)
            {
                return null;
            }
    ...
    public class PlacedBlockEvent : BlockEvent
    {
        ...
        {
            PlacedBlockEvent ple = createHead(e, EventType.onPlacedBlock, typeof(PlacedBlockEvent)) as PlacedBlockEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class DestroyBlockEvent : BlockEvent
    {
        ...
        {
            DestroyBlockEvent ple = createHead(e, EventType.onDestroyBlock, typeof(DestroyBlockEvent)) as DestroyBlockEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class StartOpenChestEvent : BlockEvent
    {
        ...
        {
            StartOpenChestEvent ple = createHead(e, EventType.onStartOpenChest, typeof(StartOpenChestEvent)) as StartOpenChestEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class StartOpenBarrelEvent : BlockEvent
    {
        ...
        {
            StartOpenBarrelEvent ple = createHead(e, EventType.onStartOpenBarrel, typeof(StartOpenBarrelEvent)) as StartOpenBarrelEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class StopOpenChestEvent : BlockEvent
    {
        ...
        {
            StopOpenChestEvent ple = createHead(e, EventType.onStopOpenChest, typeof(StopOpenChestEvent)) as StopOpenChestEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class StopOpenBarrelEvent : BlockEvent
    {
        ...
        {
            StopOpenBarrelEvent ple = createHead(e, EventType.onStopOpenBarrel, typeof(StopOpenBarrelEvent)) as StopOpenBarrelEvent;
            if (ple == null)
            {
                return null;
            }
    ...
    public class SetSlotEvent : PlayerEvent
    {
        ...
        {
            SetSlotEvent le = createHead(e, EventType.onSetSlot, typeof(SetSlotEvent)) as SetSlotEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class ChangeDimensionEvent : PlayerEvent
    {
        ...
        {
            ChangeDimensionEvent le = createHead(e, EventType.onChangeDimension, typeof(ChangeDimensionEvent)) as ChangeDimensionEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class HurtEvent : BaseEvent
    {
        ...
        /// 生物名称
        /// </summary>
        public string mobname => mmobname;
        /// <summary>
        /// 玩家名字（若为玩家死亡，附加此信息）
        /// </summary>
        public string playername => mplayername;
        ...
        /// 生物类型
        /// </summary>
        public string mobtype => mmobtype;
        /// <summary>
        /// 伤害源名称
        /// </summary>
        public string srcname => msrcname;
        /// <summary>
        /// 伤害源类型
        /// </summary>
        public string srctype => msrctype;
        /// <summary>
        /// 生物所在位置
        /// </summary>
        public Vec3 XYZ => mXYZ;
    ...
    public class MobDieEvent : HurtEvent
    {
        ...
        {
            MobDieEvent le = createHead(e, EventType.onMobDie, typeof(MobDieEvent)) as MobDieEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class MobHurtEvent : HurtEvent
    {
        ...
        /// 生物受伤具体值
        /// </summary>
        public int dmcount => mdmcount;
        public static new MobHurtEvent getFrom(Events e)
        {
            MobHurtEvent le = createHead(e, EventType.onMobHurt, typeof(MobHurtEvent)) as MobHurtEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class RespawnEvent : PlayerEvent
    {
        ...
        {
            RespawnEvent le = createHead(e, EventType.onRespawn, typeof(RespawnEvent)) as RespawnEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class ChatEvent : BaseEvent
    {
        ...
        /// 聊天类型
        /// </summary>
        public string chatstyle => mchatstyle;
        public static new ChatEvent getFrom(Events e)
        {
            ChatEvent le = createHead(e, EventType.onChat, typeof(ChatEvent)) as ChatEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class InputTextEvent : PlayerEvent
    {
        ...
        {
            InputTextEvent le = createHead(e, EventType.onInputText, typeof(InputTextEvent)) as InputTextEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class CommandBlockUpdateEvent : PlayerEvent
    {
        ...
        /// </summary>
        public string actortype => mactortype;
        /// <summary>
        /// 命令方块所在位置
        /// </summary>
        public BPos3 position => mposition;
        ...
        /// 是否是方块
        /// </summary>
        public bool isblock => misblock;
        public static new CommandBlockUpdateEvent getFrom(Events e)
        {
            CommandBlockUpdateEvent le = createHead(e, EventType.onCommandBlockUpdate, typeof(CommandBlockUpdateEvent)) as CommandBlockUpdateEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class InputCommandEvent : PlayerEvent
    {
        ...
        {
            InputCommandEvent le = createHead(e, EventType.onInputCommand, typeof(InputCommandEvent)) as InputCommandEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class BlockCmdEvent : BaseEvent
    {
        ...
        /// 命令设定的间隔时间
        /// </summary>
        public int tickdelay => mtickdelay;
        /// <summary>
        /// 执行者类型
        /// </summary>
        ...
        {
            BlockCmdEvent le = createHead(e, EventType.onBlockCmd, typeof(BlockCmdEvent)) as BlockCmdEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class NpcCmdEvent : BaseEvent
    {
        ...
        /// NPC名字
        /// </summary>
        public string npcname => mnpcname;
        /// <summary>
        /// NPC实体标识名
        /// </summary>
        public string entity => mentity;
        /// <summary>
        /// NPC所处维度
        /// </summary>
        public string dimension => mdimension;
        ...
        /// 指令列表
        /// </summary>
        public string actions => mactions;
        /// <summary>
        /// NPC所在位置
        /// </summary>
        public Vec3 position => mposition;
        /// <summary>
        /// 选择项
        /// </summary>
        ...
        /// NPC指针
        /// </summary>
        public IntPtr npcPtr => mnpc;
        /// <summary>
        /// 触发者（玩家）指针
        /// </summary>
        public IntPtr triggerPtr => mtrigger;
        public static new NpcCmdEvent getFrom(Events e)
        {
            NpcCmdEvent le = createHead(e, EventType.onNpcCmd, typeof(NpcCmdEvent)) as NpcCmdEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class LoadNameEvent : BaseEvent
    {
        ...
        /// 玩家xuid字符串
        /// </summary>
        public string xuid => mxuid;
        /// <summary>
        /// 玩家能力值列表（可选，商业版可用）
        /// </summary>
        public string ability => mability;
        /// <summary>
        /// 玩家指针
        /// </summary>
        public IntPtr playerPtr => mplayer;
        ...
        {
            LoadNameEvent le = createHead(e, EventType.onLoadName, typeof(LoadNameEvent)) as LoadNameEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class PlayerLeftEvent : LoadNameEvent
    {
        ...
        {
            PlayerLeftEvent le = createHead(e, EventType.onPlayerLeft, typeof(PlayerLeftEvent)) as PlayerLeftEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class MoveEvent : PlayerEvent
    {
        ...
        {
            MoveEvent ate = createHead(e, EventType.onMove, typeof(MoveEvent)) as MoveEvent;
            if (ate == null)
            {
                return null;
            }
    ...
    public class AttackEvent : PlayerEvent
    {
        ...
        /// 被攻击实体名称
        /// </summary>
        public string actorname => mactorname;
        /// <summary>
        /// 被攻击实体类型
        /// </summary>
        public string actortype => mactortype;
        ...
        /// 被攻击实体所处位置
        /// </summary>
        public Vec3 actorpos => mactorpos;
        /// <summary>
        /// 被击者实体指针
        /// </summary>
        public IntPtr attackedentityPtr => mattacked;
        /// <summary>
        /// 伤害类型
        /// </summary>
        public int dmcase => mdmcase;
        ...
        {
            AttackEvent ate = createHead(e, EventType.onAttack, typeof(AttackEvent)) as AttackEvent;
            if (ate == null)
            {
                return null;
            }
    ...
    public class LevelExplodeEvent : BaseEvent
    {
        ...
        /// 爆炸强度
        /// </summary>
        public float explodepower => mexplodepower;
        /// <summary>
        /// 爆炸方块ID
        /// </summary>
        public float blockid => mblockid;
        public static new LevelExplodeEvent getFrom(Events e)
        {
            LevelExplodeEvent le = createHead(e, EventType.onLevelExplode, typeof(LevelExplodeEvent)) as LevelExplodeEvent;
            if (le == null)
            {
                return null;
            }
    ...
    public class EquippedArmorEvent : PlayerEvent
    {
        ...
        /// </summary>
        public short slottype => mslottype;

        public static new EquippedArmorEvent getFrom(Events e)
        {
            EquippedArmorEvent qae = createHead(e, EventType.onEquippedArmor, typeof(EquippedArmorEvent)) as EquippedArmorEvent;
            if (qae == null)
            {
                return null;
            }
    ...
    public class LevelUpEvent : PlayerEvent
    {
        ...
        {
            LevelUpEvent soe = createHead(e, EventType.onLevelUp, typeof(LevelUpEvent)) as LevelUpEvent;
            if (soe == null)
            {
                return null;
            }
    ...
    public class ChestPairEvent : BaseEvent
    {
        ...
        /// 目标方块名称
        /// </summary>
        public string targetblockname => mtblockname;
        /// <summary>
        /// 目标方块所在位置
        /// </summary>
        public BPos3 targetposition => mtposition;
        /// <summary>
        /// 目标方块ID
        /// </summary>
        public short targetblockid => mtblockid;
        ...
        {
            ChestPairEvent pe = createHead(e, EventType.onChestPair, typeof(ChestPairEvent)) as ChestPairEvent;
            if (pe == null)
            {
                return pe;
            }
    ...
    public class PistonPushEvent : ChestPairEvent
    {
        ...
        /// 朝向
        /// </summary>
        public byte direction => mdirection;
        public static new PistonPushEvent getFrom(Events e)
        {
            PistonPushEvent pe = createHead(e, EventType.onPistonPush, typeof(PistonPushEvent)) as PistonPushEvent;
            if (pe == null)
            {
                return pe;
            }
    ...
    public class MobSpawnCheckEvent : BaseEvent
    {
        ...
        {
            MobSpawnCheckEvent pe = createHead(e, EventType.onMobSpawnCheck, typeof(MobSpawnCheckEvent)) as MobSpawnCheckEvent;
            if (pe == null)
            {
                return pe;
            }
    ...
    public class PickUpItemEvent : PlayerEvent
    {
        ...
        {
            PickUpItemEvent puie = createHead(e, EventType.onPickUpItem, typeof(PickUpItemEvent)) as PickUpItemEvent;
            if (puie == null)
            {
                return null;
            }
    ...
    public class DropItemEvent : PlayerEvent
    {
        ...
        {
            DropItemEvent puie = createHead(e, EventType.onDropItem, typeof(DropItemEvent)) as DropItemEvent;
            if (puie == null)
            {
                return null;
            }
    ...
    public class ScoreChangedEvent : BaseEvent
    {
        ...
        /// 计分板名称
        /// </summary>
        public string objectivename => mobjectivename;
        /// <summary>
        /// 计分板显示名
        /// </summary>
        ...
        /// 计分板ID值
        /// </summary>
        public long scoreboardid => mscoreboardid;
        /// <summary>
        /// 分数
        /// </summary>
        ...
        {
            ScoreChangedEvent sce = createHead(e, EventType.onScoreChanged, typeof(ScoreChangedEvent)) as ScoreChangedEvent;
            if (sce == null)
            {
                return null;
            }
    ...
    public class ScriptEngineInitEvent : BaseEvent
    {
        ...
        /// 脚本引擎指针
        /// </summary>
        public IntPtr jseptr => mjseptr;
        public static new ScriptEngineInitEvent getFrom(Events e)
        {
            ScriptEngineInitEvent sce = createHead(e, EventType.onScriptEngineInit, typeof(ScriptEngineInitEvent)) as ScriptEngineInitEvent;
            if (sce == null)
            {
                return null;
            }
    ...
    public class ScriptEngineLogEvent : ScriptEngineInitEvent
    {
        ...
        /// </summary>
        public string log => mlog;
        public static new ScriptEngineLogEvent getFrom(Events e)
        {
            ScriptEngineLogEvent sce = createHead(e, EventType.onScriptEngineLog, typeof(ScriptEngineLogEvent)) as ScriptEngineLogEvent;
            if (sce == null)
            {
                return null;
            }
    ...
    public class ScriptEngineCmdEvent : ScriptEngineInitEvent
    {
        ...
        {
            ScriptEngineCmdEvent sce = createHead(e, EventType.onScriptEngineCmd, typeof(ScriptEngineCmdEvent)) as ScriptEngineCmdEvent;
            if (sce == null)
            {
                return null;
            }
    ...
    public class ScoreboardInitEvent : BaseEvent
    {
        ...
        /// 系统计分板指针
        /// </summary>
        public IntPtr scptr => mscptr;
        public static new ScoreboardInitEvent getFrom(Events e)
        {
            ScoreboardInitEvent sce = createHead(e, EventType.onScoreboardInit, typeof(ScoreboardInitEvent)) as ScoreboardInitEvent;
            if (sce == null)
            {
                return null;
            }
