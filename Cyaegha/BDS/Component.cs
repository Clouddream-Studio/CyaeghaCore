...
namespace DNR
{
    ...
    {
        private const string ENTITY_GET_ARMOR_CONTAINER = "entity.get_armor_container";
        private const string ENTITY_GET_ATTACK = "entity.get_attack";
        private const string ENTITY_SET_ATTACK = "entity.set_attack";
        private const string ENTITY_GET_COLLISION_BOX = "entity.get_collision_box";
        private const string ENTITY_SET_COLLISION_BOX = "entity.set_collision_box";
        private const string ENTITY_GET_HAND_CONTAINER = "entity.get_hand_container";
        private const string ENTITY_GET_HEALTH = "entity.get_health";
        private const string ENTITY_SET_HEALTH = "entity.set_health";
        private const string ENTITY_GET_INVENTORY_CONTAINER = "entity.get_inventory_container";
        private const string ENTITY_GET_NAME = "entity.get_name";
        private const string ENTITY_SET_NAME = "entity.set_name";
        private const string ENTITY_GET_POSITION = "entity.get_position";
        private const string ENTITY_SET_POSITION = "entity.set_position";
        private const string ENTITY_GET_ROTATION = "entity.get_rotation";
        private const string ENTITY_SET_ROTATION = "entity.set_rotation";
        private const string ENTITY_GET_DIMENSIONID = "entity.get_dimensionid";
        private const string ENTITY_GET_TYPEID = "entity.get_typeid";
        private const string ENTITY_GET_UNIQUEID = "entity.get_uniqueid";
        private const string ENTITY_REMOVE = "entity.remove";
        private const string ENTITY_HURT = "entity.hurt";
        #region 非社区内容
        private const string ENTITY_GET_ABILITIES = "entity.get_abilities";
        private const string ENTITY_SET_ABILITIES = "entity.set_abilities";
        private const string ENTITY_GET_ATTRIBUTES = "entity.get_attributes";
        private const string ENTITY_SET_ATTRIBUTES = "entity.set_attributes";
        private const string ENTITY_GET_MAXATTRIBUTES = "entity.get_maxattributes";
        private const string ENTITY_SET_MAXATTRIBUTES = "entity.set_maxattributes";
        private const string ENTITY_GET_EFFECTS = "entity.get_effects";
        private const string ENTITY_SET_EFFECTS = "entity.set_effects";
        #endregion
        private const string LEVEL_GETFROM_UNIQUEID = "level.getfrom_uniqueid";
        private const string LEVEL_GETSFROM_AABB = "level.getsfrom_aabb";
        ...
        protected static AGET egetArmorContainer;
        protected static AGET egetAttack;
        protected static ASET esetAttack;
        protected static AGET egetCollisionBox;
        protected static ASET esetCollisionBox;
        protected static AGET egetHandContainer;
        protected static AGET egetHealth;
        protected static ASET esetHealth;
        protected static AGET egetInventoryContainer;
        protected static AGET egetName;
        protected static ASETNAME esetName;
        protected static AGET egetPosition;
        protected static ASET esetPosition;
        protected static AGET egetRotation;
        protected static ASET esetRotation;
        protected static AGETDIMENSIONID egetDimensionId;
        protected static AGETDIMENSIONID egetTypeId;
        protected static AGETUNIQUEID egetUniqueId;
        protected static AREMOVE eremove;
        protected static AHURT ehurt;
        #region 非社区内容
        protected static AGET egetAbilities;
        protected static ASET esetAbilities;
        protected static AGET egetAttributes;
        protected static ASET esetAttributes;
        protected static AGET egetMaxAttributes;
        protected static ASET esetMaxAttributes;
        protected static AGET egetEffects;
        protected static ASET esetEffects;
        #endregion
        protected static AGETFROMUNIQUEID egetFromUniqueId;
        protected static AGETSFROMAABB egetsFromAABB;
        private static bool entityApiInited = false;

        protected static bool initEntityAPI(MCNETAPI api)
        {
            if (!entityApiInited)
            {
                if (api != null)
        ...
        protected static MCNETAPI mapi;
        protected IntPtr ptr;

        public CsActor(MCNETAPI api, IntPtr e)
        {
            if (mapi == null)
            {
                mapi = api;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static CsActor getFromUniqueId(MCNETAPI api, ulong id)
        {
        ...
        public static ArrayList getsFromAABB(MCNETAPI api, int did, float x1, float y1, float z1, float x2, float y2, float z2)
        {
    ...
    {
        private const string PLAYER_GET_HOTBAR_CONTAINER = "player.get_hotbar_container";
        private const string PLAYER_GET_UUID = "player.get_uuid";
        private const string PLAYER_GET_IPPORT = "player.get_ipport";
        private const string PLAYER_ADD_LEVEL = "player.add_level";
        private const string PLAYER_GET_SCOREID = "player.get_scoreboardid";
        private const string PLAYER_CREATE_SCOREID = "player.create_scoreboardid";
        private const string LEVEL_GETPLFROM_AABB = "level.getplfrom_aabb";
        #region 非社区内容
        private const string PLAYER_GET_STORAGEID = "player.get_storageid";
        #endregion

        protected delegate bool PADDLEVEL(IntPtr p, int lv);
        protected delegate long PGETSCOREID(IntPtr p);

        private static AGET pgetHotbarContainer, pgetServerStorageID;
        private static AGET pgetUuid;
        private static AGET pgetIPPort;
        private static PADDLEVEL paddLevel;
        private static AGETSFROMAABB pgetplFromAABB;
        private static PGETSCOREID pgetScoreboardId, pcreateScoreboardId;
        private static bool playerApiInited = false;

        private static bool initPlayerAPI(MCNETAPI api)
        {
            if (!playerApiInited)
            {
                if (api != null)
        ...
        public CsPlayer(MCNETAPI api, IntPtr p) : base(api, p)
        {
            initPlayerAPI(api);
        }
        /// <summary>
        ...
        #region 非社区内容
        public string StorageID => (ptr != null && ptr != IntPtr.Zero) ?
        ...
        public static ArrayList getplFromAABB(MCNETAPI api, int did, float x1, float y1, float z1, float x2, float y2, float z2)
        {
